...
export function LaserHero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col overflow-hidden bg-[#0d0d0d] max-w-container mx-auto border-x border-[#1f1f1f] w-full"
    >
      {/* Navbar Gorx v2 */}
      <header className="relative z-20 w-full backdrop-blur-sm border-b border-[#1f1f1f] bg-[#0d0d0d]/90">
        <div className="px-6 flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#sobre" className="text-sm text-[#666] hover:text-white transition-colors">
              Sobre
            </a>
            <a href="#servicos" className="text-sm text-[#666] hover:text-white transition-colors">
              Habilidades
            </a>
            <a href="#projetos" className="text-sm text-[#666] hover:text-white transition-colors">
              Projetos
            </a>
            <a href="#processo" className="text-sm text-[#666] hover:text-white transition-colors">
              Processo
            </a>
            <a href="#contato" className="text-sm text-[#666] hover:text-white transition-colors">
              Contato
            </a>
          </nav>
          <a
      ...
      <div className="absolute top-4 left-2 h-40 w-40 bg-[#bff549]/80 blur-[200px]"></div>

      {/* Hero Content */}
      <div className="relative z-10 flex-1 flex flex-col justify-center pt-20 pb-16">
        <div className="w-full px-6 md:px-12">
          <div className="inline-flex items-center gap-2 px-2 py-1 bg-[#141414]/60 pr-3 backdrop-blur-sm border border-[#1f1f1f] mb-8">
            <span className="px-2 py-0.5 bg-[#bff549] text-[#0d0d0d] text-xs font-bold">Novo</span>
            <span className="text-sm text-[#aaa] tracking-tight">Disponível para novos projetos em 2026</span>
          </div>

          {/* Main Headline */}
          <h1 className="text-5xl md:text-7xl font-bold text-balance mb-6 text-white leading-tight">
            Desenvolvo interfaces rápidas
            <br />
            <span className="text-[#aaa]">e código limpo.</span>
          </h1>

          {/* Subheadline */}
          <p className="text-xl text-[#aaa] text-balance mb-12 max-w-2xl leading-relaxed">
            Desenvolvedor frontend &amp; fullstack apaixonado por interfaces bem feitas e código que escala — do design ao deploy, com foco em performance, acessibilidade e experiência do usuário.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 mb-16">
            <a
              href="#contato"
              className="bg-[#bff549] text-[#0d0d0d] hover:bg-white px-8 py-4 text-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2"
            >
              Falar comigo
            ...
            <a
              href="#projetos"
              className="border border-[#1f1f1f] bg-transparent hover:bg-[#141414]/50 text-white px-8 py-4 text-lg font-semibold transition-all duration-300 flex items-center justify-center"
            >
              Ver projetos
            </a>
          </div>
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 z-[1] bg-gradient-to-t from-[#0d0d0d]/60 via-transparent to-[#0d0d0d]/40 pointer-events-none" />
    </section>
  )
}
