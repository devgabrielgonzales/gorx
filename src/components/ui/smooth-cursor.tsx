...
const DESKTOP_POINTER_QUERY = "(pointer: fine)"
...
export function SmoothCursor({
  ...
  useEffect(() => {
    ...
    const smoothPointerMove = (e: PointerEvent) => {
      ...
      const hoveredTarget = e.target as Element | null
      const isOverInteractive = Boolean(
        hoveredTarget?.closest(INTERACTIVE_SELECTOR)
      )
      setIsPointer(isOverInteractive)
      ringScale.set(isOverInteractive ? 1 : 0)
  ...
  }, [cursorX, cursorY, rotation, scale, ringScale, isEnabled])
